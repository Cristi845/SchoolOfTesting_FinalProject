...
public class RegistrationOnlyForLegalAdultsTest {
    ...
    @Test
    public void RegistrationOnlyForLegalAdults(){
        registrationPage.selectDayOfBirth("10");
        registrationPage.selectMonthOfBirth("11");
        registrationPage.selectYearOfBirth("2005");
        registrationPage.clickOnRegisterButton();
        assertThat(registrationPage.getErrorMessage(),is("You need to be over 18\n"+
                "years old to create an account on this website"));
    }
}
