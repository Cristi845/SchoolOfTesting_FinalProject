...
public class ZipFieldTest {
    ...
    @Test // negative path test
    public void ZipField(){
        registrationPage.fillInZipPostalCode("000000"); //000000
        registrationPage.clickOnRegisterButton();
        assertThat(registrationPage.getErrorMessage(),is("There is 1 error\n"+
